...
architecture structural of subition is
...
begin
    ...
    stage0: FA port map(sw_A(0), sw_B(0) xor i_cin , i_cin xor readme,    sum_res(0), carry(0));
    ...
    stage7: FA port map(sw_A(7), sw_B(7) xor i_cin , carry(6), sum_res(7), carry(7));
	 ...
	 readme <= carry(7) xor i_Cin;

    display_unit: seven_displays port map (
        sw0 => sum_res(0) xor readme, sw1 => sum_res(1) xor readme, sw2 => sum_res(2) xor readme, sw3 => sum_res(3) xor readme,
        sw4 => sum_res(4) xor readme, sw5 => sum_res(5) xor readme, sw6 => sum_res(6) xor readme, sw7 => sum_res(7) xor readme,
